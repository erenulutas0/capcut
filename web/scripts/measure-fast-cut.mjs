...
// ADR-026: without the save dialog the download takes the OPFS route and ends
// with "Bilgisayara kaydet" — the route ADR-020/024/027 measured.
...
for (const [a, b] of keep) await addKesit(page, a.toFixed(3), b.toFixed(3));
...
// The capability gate now runs on this click too (ADR-026), inside the timing.

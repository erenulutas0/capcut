...
export const tr = {
  ...
  'export.fallback.bitstream': 'kaynağın H.264 biçimi kopyalanamıyor',
  'export.fallback.color': 'kaynağın renk aralığı kopyalanamıyor',
  'export.fallback.crop': 'kırpma veya yakınlaştırma var',
  ...
  'export.fallback.encoder': 'bu tarayıcı kesim karelerini kodlayamıyor',
...
export const en: Record<MessageKey, string> = {
  ...
  'export.fallback.bitstream': 'the source’s H.264 format cannot be copied',
  'export.fallback.color': 'the source’s colour range cannot be copied',
  'export.fallback.crop': 'a crop or zoom is set',
  ...
  'export.fallback.encoder': 'this browser cannot encode the cut frames',

...
export const tr = {
  ...
  'export.method.copy': 'Hızlı kesim — görüntü yeniden kodlanmadı',
  'export.method.smart': 'Hızlı kesim — görüntü yeniden kodlanmadı; yalnızca kesim noktalarındaki {count} kare kodlandı',
  ...
  'export.fallback.fps': 'kaynak 30 fps’den hızlı',
...
export const en: Record<MessageKey, string> = {
  ...
  'export.method.copy': 'Fast cut — the picture was not re-encoded',
  'export.method.smart': 'Fast cut — the picture was not re-encoded; only the {count} frames at the cut points were encoded',
  ...
  'export.fallback.fps': 'the source is faster than 30 fps',

...
|---|---|---|---|
| Chromium (Playwright) | 153.0.8010.12 | H.264 var · AAC var | 2026-09-22 23:56 UTC |
| Google Chrome | 153.0.0.0 | H.264 var · AAC var | 2026-09-23 00:31 UTC |
| Microsoft Edge | 153.0.0.0 | H.264 var · AAC var | 2026-09-23 00:33 UTC |
| Firefox (Playwright) | 155.0 | H.264 var · AAC yok | 2026-09-23 00:34 UTC |
| WebKit (Playwright) | 26.6 | WebCodecs yok | 2026-09-23 00:34 UTC |
...
| Toplam | | 21✅ 0⛔ 0❌ 0💥 0— | 21✅ 0⛔ 0❌ 0💥 0— | 21✅ 0⛔ 0❌ 0💥 0— | 5✅ 16⛔ 0❌ 0💥 0— | 0✅ 0⛔ 0❌ 0💥 21— |
...
| M10-hdr | 3.008 s | 90 | 1280x720 | 0.9673 | HDR→SDR: en yakın ref-hable, ΔE00 3.089, kayma 3.552, doygunluk 1.005..1.006, ton 1.954°, kırpma -0.047 |
| M10-hdr-hlg | 3.008 s | 90 | 720x1280 | 0.9333 | HDR→SDR: en yakın ref-hable, ΔE00 4.761, kayma 4.141, doygunluk 0.962..0.963, ton 1.751°, kırpma -0.047 |
...
- **WebKit (Playwright):** Bu tarayıcı temel H.264 fixture'ını açamıyor, dolayısıyla matris burada çalıştırılamaz. Uygulamanın mesajı: "“m01-portrait-20s.mp4” açılamadı: bu dosyanın önizlemesi bu tarayıcıda açılamadı. Dosya bozuk olabilir veya tarayıcı bu formatı oynatmıyor.".
...
### Chromium (Playwright) — 10 PASS, 4 REFUSED, 1 FAIL, 0 ERROR (2026-09-22 23:54 UTC)

| # | Durum | Codec | Boyut | Rotasyon | fps | Süre | Dosya | Renk | Ses | SSIM |
|---|---|---|---|---|---|---|---|---|---|---|
| R01 | PASS | h264 | 854x480 | 0° | 24 | 1957.4 s | 257.7 MiB | — | aac | 0.9837 |
| R02 | PASS | h264 | 592x1280 | 0° | 40.588 (VFR?) | 29.5 s | 3.9 MiB | — | aac | 0.9832 |
| R03 | PASS | h264 | 720x1280 | 0° | 30.004 | 22.8 s | 2.8 MiB | — | aac | 0.9857 |
| R04 | PASS | h264 | 480x724 | 0° | 29.934 | 45.1 s | 1.7 MiB | — | aac | 0.977 |
| R05 | PASS | h264 | 1080x1920 | 0° | 30 | 14.2 s | 1.3 MiB | bt709 | aac | 0.9965 |
| R06 | PASS | h264 | 1280x720 | 0° | 24.334 (VFR?) | 16.9 s | 21.7 MiB | bt709 | aac | 0.9139 |
| R07 | PASS | h264 | 1280x720 | 0° | 59.94 | 16.5 s | 24.1 MiB | — | aac | 0.969 |
| R08 | PASS | h264 | 224x128 | 0° | 15 | 34.4 s | 0.7 MiB | bt709 | aac | 0.9862 |
| R09 | REFUSED | hevc | 3840x2160 | 0° | 29.024 | 1.1 s | 6.8 MiB | smpte2084 | aac | — |
| R10 | PASS | h264 | 1920x1080 | 0° | 29.974 | 341.2 s | 618.3 MiB | bt709 | aac | 0.9252 |
| R11 | REFUSED | hevc | 1920x1080 | -90° | 56.536 (VFR?) | 21.7 s | 33.3 MiB | arib-std-b67 | aac | — |
| R12 | PASS | h264 | 1920x1080 | -180° | 59.93 | 88.7 s | 249 MiB | bt709 | aac | 0.9139 |
...
### Google Chrome — 15 PASS, 0 REFUSED, 0 FAIL, 0 ERROR (2026-09-23 00:28 UTC)
...
- R11 HDR→SDR: en yakın placebo-spline, ΔE00 5.284, kayma 1.097, doygunluk 1.02..1.154, ton 8.443°, kırpma 0

### Microsoft Edge — 11 PASS, 4 REFUSED, 0 FAIL, 0 ERROR (2026-09-22 23:51 UTC)

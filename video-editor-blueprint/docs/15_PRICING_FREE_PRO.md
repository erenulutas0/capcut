...
Politika kimliği: `2026-09-23.v4`. Limitler ürün güvenliği için başlangıç önerisidir; teknik motorların mutlak maksimum kapasitesi değildir. Daha fazla para ödemek desteklenmeyen codec/donanımı destekli yapmaz.
...
| Web yerel limitleri | 60 dakika çıktı (diske yazamayan tarayıcıda 5 dakika) / 120 dakika video girdi / 2 GiB toplam | İlk destek matrisinde aynı; Pro tarayıcı sınırını artırmaz |

...
P0 sonrası test edilmiş limit yükseltilene kadar web yerel işlerde **tüm planlarda 250 MiB toplam kaynak, 20 dakika toplam video girdi süresi, 5 dakika çıktı** başlangıç koruması vardır. Bir abonelik tarayıcının bellek/codec sınırını ortadan kaldırmaz. Sayılar kanonik [politika belgesinde](15_PRICING_FREE_PRO.md) bulunur.
